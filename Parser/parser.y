...
EXPRESSION:
    ...
    |   BOOL_EXP                        { $$ = $1; }
    |   STRING_EXP                      { $$ = $1; }
    |   IDENTIFIER                      { $$ = new_variable_node($1, NULL); }
    ...
    |   EXPRESSION OP_IS_EQ         EXPRESSION  { $$ = new_binary_op(AST_EQUALS,        $1, $3); }
    |   EXPRESSION OP_ISNT_EQ       EXPRESSION  { $$ = new_binary_op(AST_NOT_EQUALS,    $1, $3); }
    ;

%%

// The lexer and main function 
    INT_EXP:
            INTEGER_LITERAL { $$ = $1; }
        ;
